...
using VirtualAssistant.Middleware.Handoff.CommandHandling;
using VirtualAssistant.Middleware.Handoff.MessageRouting;
using VirtualAssistant.Middleware.Handoff.ConversationHistory;

namespace VirtualAssistant.Middleware.Handoff
{
